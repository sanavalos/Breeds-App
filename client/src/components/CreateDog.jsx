...
function CreateDog() {
    ...
    useEffect(() => {
        ...
        else if (input.weight_min === '' || input.weight_min < '1' || input.weight_max === '' || input.weight_min >= input.weight_max) {
            setError('Something is wrong with the weight')
        }
        else if (input.height_min === '' || input.height_min < '1' || input.height_max === '' || input.height_min >= input.height_max) {
                ...
                <CreateDiv>
                    ...
                    <DogForm onSubmit={e => handleSubmit(e)}>
                        <div className='formBorder'>
                            <div className='box'>
                                <div>
                                    <label htmlFor='name'><span>*</span>Breed: </label>
                                    <input type='text' value={input.name} id='name' name='name' onChange={e => handleChange(e)} />
                                </div>

                                <div>
                                    <label htmlFor='temperaments'><span>*</span>Temperaments: </label>
